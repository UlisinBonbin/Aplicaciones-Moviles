...
class AuthInterceptor (private val sessionRepository: SessionRepository) : Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response {
        // Obtener el token guardado desde DataStore.
        ...
        // Obtener la petición original que se va a realizar.
        ...
        // Si hay token, construimos una nueva petición.
        // Copiamos la original y le añadimos la cabecera "Authorization".
        val newRequest = request.newBuilder()
            .header("Authorization", "Bearer $token")
            .build()

        // Procedemos con la nueva peticion que ahora incluye el token.
